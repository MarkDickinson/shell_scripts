...
# Syntax: makepdf.sh somefilename.txt somefilename.pdf
#
# Defaults as set are landscape, 132cols, 72 lines (lineflow),
# as my primary use it to pipe output from a hercules pipe
# printer through it.
#
...
#
# It has a chunk of code in it dedicated to handling random line
# breaks the hercules printer will pass which you can remove if
# you only intend to use it as a text to PDF converter.
#
